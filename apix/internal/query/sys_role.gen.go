...
func newSysRole(db *gorm.DB) sysRole {
	...
	_sysRole.ParentRoleID = field.NewInt64(tableName, "parent_role_id")
	_sysRole.RoleFlag = field.NewString(tableName, "role_flag")
	_sysRole.RoleLevel = field.NewString(tableName, "role_level")
	_sysRole.RoleCode = field.NewString(tableName, "role_code")
	_sysRole.CreateTime = field.NewInt64(tableName, "create_time")
	_sysRole.UpdateTime = field.NewInt64(tableName, "update_time")
	_sysRole.ModifyTime = field.NewTime(tableName, "modify_time")
...
type sysRole struct {
	...
	ParentRoleID field.Int64
	RoleFlag     field.String
	RoleLevel    field.String
...
func (s *sysRole) updateTableName(table string) *sysRole {
	...
	s.ParentRoleID = field.NewInt64(table, "parent_role_id")
	s.RoleFlag = field.NewString(table, "role_flag")
	s.RoleLevel = field.NewString(table, "role_level")
...
func (s *sysRole) fillFieldMap() {
	...
	s.fieldMap["parent_role_id"] = s.ParentRoleID
	s.fieldMap["role_flag"] = s.RoleFlag
	s.fieldMap["role_level"] = s.RoleLevel
