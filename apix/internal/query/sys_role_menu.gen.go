...
func newSysRoleMenu(db *gorm.DB) sysRoleMenu {
	...
	_sysRoleMenu.CreateTime = field.NewInt64(tableName, "create_time")
	_sysRoleMenu.UpdateTime = field.NewInt64(tableName, "update_time")
	_sysRoleMenu.ModifyTime = field.NewTime(tableName, "modify_time")
	_sysRoleMenu.DeleteTime = field.NewField(tableName, "delete_time")
	_sysRoleMenu.Type = field.NewString(tableName, "type")
