...
func newSysUserRole(db *gorm.DB) sysUserRole {
	_sysUserRole := sysUserRole{}

	_sysUserRole.sysUserRoleDo.UseDB(db)
	_sysUserRole.sysUserRoleDo.UseModel(&model.SysUserRole{})

	tableName := _sysUserRole.sysUserRoleDo.TableName()
	_sysUserRole.ALL = field.NewField(tableName, "*")
	_sysUserRole.ID = field.NewInt64(tableName, "id")
	_sysUserRole.UserID = field.NewInt64(tableName, "user_id")
	_sysUserRole.AccountID = field.NewInt64(tableName, "account_id")
	_sysUserRole.RoleID = field.NewInt64(tableName, "role_id")
	_sysUserRole.CreateTime = field.NewInt64(tableName, "create_time")
	_sysUserRole.UpdateTime = field.NewInt64(tableName, "update_time")
	_sysUserRole.ModifyTime = field.NewTime(tableName, "modify_time")
	_sysUserRole.DeleteTime = field.NewField(tableName, "delete_time")
